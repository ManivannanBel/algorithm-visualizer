...
export class VisualizerComponent extends Component {
  ...
  selectAlgorithm = algorithm => {
    ...
    switch (algorithm) {
      ...
      case "Depth first search":
        description =
          "Depth Fisrt Search is an unweighted graph search algorithm used for traversing or searching in a graph. It does not guarantee the shortest path";
        break;
      case "Breadth frist search":
        description =
          "Breadth Fisrt Search is an unweighted graph search algorithm used for traversing or searching in a graph. It guarantees the shortest path";
        break;
      case "Greedy Best first search":
        description =
        ...
        <div>
          <Navbar bg="light">
            ...
            >
              ...
              <NavDropdown.Item
                href=""
                onClick={() => this.selectAlgorithm("Greedy Best first search")}
              >
                Greedy Best Fisrt Search
              </NavDropdown.Item>
              <NavDropdown.Item
                href=""
              ...
              <NavDropdown.Item
                href=""
                onClick={() => this.selectAlgorithm("Bidirectional BFS")}
              >
            ...
            >
              ...
              <NavDropdown.Item onClick={() => this.selectSpeed("medium")}>
                Medium
              </NavDropdown.Item>
